...
public class StringFormatValuelsValidRule implements Rule {

    private static final Rule instance = new StringFormatValuelsValidRule();
    private StringFormatValuelsValidRule() {
