...
public class idValuesNotDefaultValuesRule implements Rule {


    private static final Rule instance = new idValuesNotDefaultValuesRule();
    private idValuesNotDefaultValuesRule() {
